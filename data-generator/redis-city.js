...
let coordinates = [
  [37.788164, 37.722025, -122.508212, -122.370385],
  [47.732895, 47.553408, -122.425989, -122.266016],
  [41.310582, 41.202976, -96.117089, -95.939122],
  [36.189783, 36.145853, -115.240241, -115.105658],
  [40.866646, 40.595648, -74.211799, -73.73899],
  [45.626458, 45.43942, -122.828151, -122.523324],
  [30.318942, 30.19113, -97.819412, -97.620285],
  [34.25772, 33.959813, -118.627374, -118.171441],
  [42.01093, 41.646129, -87.865181, -87.524605],
  [33.713689, 33.295646, -112.335199, -111.820495],
  [40.072859, 39.918999, -75.275969, -74.998564],
  [29.662686, 29.292979, -98.749273, -98.294027],
  [33.058199, 32.670338, -117.272435, -117.017003],
  [32.951477, 32.65078, -96.980117, -96.602462],
  [37.396827, 37.248854, -122.026161, -121.795448],
  [30.445009, 30.1951, -81.7559, -81.518321],
  [40.087487, 39.873479, -83.143272, -82.851104],
  [39.895695, 39.706052, -86.312659, -86.043494],
  [32.952743, 32.588705, -97.492601, -97.153605],
  [35.335937, 35.098933, -80.977853, -80.693582],
  [39.792587, 39.650654, -105.058574, -104.8567],
  [31.984195, 31.660687, -106.631893, -106.285137],
  [38.980633, 38.820774, -77.134054, -76.937959],
  [42.36299, 42.259027, -71.186585, -71.007714],
  [42.430407, 42.32719, -83.285975, -82.92068],
  [36.360988, 36.080279, -86.972129, -86.661422],
  [35.207688, 35.018122, -90.075166, -89.813554],
  [35.626135, 35.313817, -97.793003, -97.222401],
  [38.271786, 38.123124, -85.870413, -85.471472],
  [39.320816, 39.260636, -76.708722, -76.552853]
  ]

var randomCoordinates = function() {
  var index = Math.floor(Math.random() * (30 - 0));
  return [coordinates[index][0], coordinates[index][1]];
}

module.exports = {
  findCity: () => {
    var coordinates = randomCoordinates();
    for (var key in citiesWithCoordinates) {
      if (citiesWithCoordinates[key].latitude[0] === coordinates[0]) {
        return key;
      }
    }
  },
